...
### YOUR CODE HERE
REGULARIZATION = np.array([0.03, 0.01, 0.003, 0.001, 0.0003, 0.0001, 0.00003, 0.00001])*0.01
# REGULARIZATION = [1e-3]
### END YOUR CODE
...
### YOUR CODE HERE
devAs = [r['dev'] for r in results]
idx = np.argmax(devAs)
BEST_REGULARIZATION = results[idx]['reg']
BEST_WEIGHTS = results[idx]['weights']
### END YOUR CODE
